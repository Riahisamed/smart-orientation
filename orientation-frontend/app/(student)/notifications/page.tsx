  ...
  return (
    <div className="min-h-screen bg-slate-100 px-4 py-8 dark:bg-slate-950">
      <div className="mx-auto max-w-3xl space-y-5">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">{t("notifications.pageTitle")}</h1>
        ...
        <div className="space-y-3">
          {loading && <p className="text-slate-500">{t("notifications.loading")}</p>}
